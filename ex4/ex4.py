...
def trainNN(mylambda=0.):
    ...
    result = scipy.optimize.fmin_cg(computeCost, x0=randomThetas_unrolled, fprime=backPropagate,                                args=(flattenX(X),y,mylambda),maxiter=50,disp=True,full_output=True)
